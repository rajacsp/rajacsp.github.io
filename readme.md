...
If this is your first time visiting this wiki, take a look at [outline](https://rajacsp.github.io/#outline)
...
- [Computer Science](https://rajacsp.github.io/computer-science/)
    - [AI](https://rajacsp.github.io/ai/)
        ...
        - [LLM](https://rajacsp.github.io/ai/llm/)
        - [Computer Vision](https://rajacsp.github.io/ai/computer-vision-cv/)
        - [NLP](https://rajacsp.github.io/ai/nlp/)
        - [Deep Learning](https://rajacsp.github.io/ai/deep-learning/)
    - [Algorithms](https://rajacsp.github.io/algorithms/)
    - [Data Structures](https://rajacsp.github.io/data-structures/)
    - [Languages](https://rajacsp.github.io/languages/)
        - [Python](https://rajacsp.github.io/python/)
    - [Networking](https://rajacsp.github.io/networking/)
    - [Databases](https://rajacsp.github.io/databases/)
        - [SQL Databases](https://rajacsp.github.io/databases/sql-databases/)
        - [NoSQL Databases](https://rajacsp.github.io/databases/nosql-databases/)
        - [Data Warehouses](https://rajacsp.github.io/databases/data-warehouses/)
    - [Frontend](https://rajacsp.github.io/frontend/)
    - [DevOps](https://rajacsp.github.io/devops/)
        - [Kubernetes](https://rajacsp.github.io/devops/kubernetes/)
    - [Cloud - AWS](https://rajacsp.github.io/cloud/aws/)
    - [Cloud - Others](https://rajacsp.github.io/cloud/others/)
    - [Technologies](https://rajacsp.github.io/technologies/)
        - [Apache Airflow](https://rajacsp.github.io/technologies/apache-airflow/)
        - [Kafka](https://rajacsp.github.io/technologies/kafka/)
    - [Decentralized Applications / Cryptocurrencies](https://rajacsp.github.io/decentralized-applications/)
- [Book Summaries](https://rajacsp.github.io/book-summaries/)
- [Mathematics](https://rajacsp.github.io/mathematics/)
- [Knowledge](https://rajacsp.github.io/knowledge/)
    - [Economics](https://rajacsp.github.io/economics/)
    - [Management](https://rajacsp.github.io/management/)
    - [Psychology](https://rajacsp.github.io/psychology/)

## Getting started

This garden is quite literally my digital brain. It includes my thoughts, notes and links on topics I care about.

I update the notes daily in my [github repo](https://github.com/rajacsp/rajacsp.github.io/), and build it few times in a month using Github Actions and Docusaurus.

The content being markdown files, which after every commit to the builds the website using docusaurus and publishes it to [rajacsp.github.io](https://rajacsp.github.io/) from which you are likely reading this page.
...
- [Quotes](https://rajacsp.github.io/knowledge/quotes-proverbs/) small phrases that makes my day and help me to remember and revise simple rules in a fun way
- [Mental Models](https://rajacsp.github.io/knowledge/general/mental-models/) that I have compiled over the years and helps me learn concepts quickly of any domain and connect concepts across domains
- [Learning how to learn](https://rajacsp.github.io/psychology/learning/learning-intro/) course that changed my learning approach and in turn my whole life, and the reason why I write and maintain these notes.
- [Book - Principles by Ray Dalio](https://rajacsp.github.io/book-summaries/principles/)
